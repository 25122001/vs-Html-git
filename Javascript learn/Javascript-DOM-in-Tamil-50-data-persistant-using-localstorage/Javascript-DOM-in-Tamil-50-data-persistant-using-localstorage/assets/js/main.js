...
const handleInputFood = () => {
  ...
  // set localStorage  ----> Browser console > application > storage> local storage
  localStorage.setItem(localStorageKey,JSON.stringify([...JSON.parse(localStorage.getItem(localStorageKey) || "[]"), // empty array is created to push values
