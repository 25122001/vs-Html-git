...
//query selctor gives node js

const result = document.querySelector("li:last-child");                                             
console.log(result.innerText);  //innerText = Works with Elements

const result1 = document.querySelectorAll("div"); // query selector = first occurence of selected tag
                                                //  queryselectorall = All occurence of selected tag
console.log(result1);
